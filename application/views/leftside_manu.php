            ...
            <div class="col-lg-9 col-sm-12 col-md-9 bounceInUp animated">
                <div id='rev_slider_4_wrapper' class='rev_slider_wrapper fullwidthbanner-container' >
                    <div id='rev_slider_4' class='rev_slider fullwidthabanner'>
                        <ul>
                            <li data-transition='random' data-slotamount='7' data-masterspeed='1000' data-thumb='<?php echo base_url(); ?>images/slider-img/slider_a5.html'><img src='<?php echo base_url(); ?>images/slider-img/slider_a5.jpg'  data-bgposition='left top'  data-bgfit='cover' data-bgrepeat='no-repeat' alt="banner1"  />
                            ...
                            <li data-transition='random' data-slotamount='7' data-masterspeed='1000' data-thumb='<?php echo base_url(); ?>images/slider-img/slider_a2.jpg' class="black-text"><img src='<?php echo base_url(); ?>images/slider-img/slider_a2.jpg'  data-bgposition='left top'  data-bgfit='cover' data-bgrepeat='no-repeat' alt="banner"  />
