        ...
        <div class="col-main">
            <div class="cart wow bounceInUp animated">
                        ...
                        <fieldset>
                            <table class="data-table cart-table" id="shopping-cart-table">
                                ...
                                <tbody>
                                    ...
                                    <tr class="first odd" ng-repeat="content in contents">
                                        <td class="image"><a class="product-image" title="{{content.name}}" href="#/women-s-crepe-printed-black/"><img width="75" height="75" alt="Sample Product" src="<?php echo base_url()?>{{content.image}}"></a></td>
                ...
                <div class="cart-collaterals row">
                    ...
                    <div class="col-sm-4">
                        <form method="post" action="http://newsmartwave.net/magento/kallyas/index.php/checkout/cart/couponPost/" id="discount-coupon-form">
                            <div class="discount">
                            ...
                            <table class="table shopping-cart-table-total" id="shopping-cart-totals-table">
                                ...
                                <tfoot>
                                    <tr>
                                        ...
                                        <td class="a-right" style=""><strong><span class="price">Tk. {{totalAmount}}</span></strong></td>
                                    </tr>
                                </tfoot>
                                <tbody>
                                    <tr>
                                        <td colspan="1" class="a-left" style=""> Subtotal </td>
                                        <td class="a-right" style=""><span class="price">$00</span></td>
                                    </tr>
                                </tbody>
                            </table>
                            <ul class="checkout">
                    ...
                    <ul id="crosssell-products-list" class="products-grid first odd">
                        <li class="item col-md-3 col-sm-6 col-xs-6">
                            <div class="col-item">
                                ...
                                <div class="product-image-area"> <a class="product-image" title="Sample Product" href="product-detail.html"> <img alt="a" class="img-responsive" src="<?php echo base_url();?>products-images/p15.jpg"> </a></div>
                                <div class="actions-links"><span class="add-to-links"> <a title="magik-btn-quickview" class="magik-btn-quickview" href="quick-view.html"><span>quickview</span></a> <a href="#" class="link-wishlist" title="Add to Wishlist"><span>Add to Wishlist</span></a> <a href="#" class="link-compare" title="Add to Compare"><span>Add to Compare</span></a></span> </div>
                                <div class="info">
