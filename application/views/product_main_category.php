...
<section class="main-container col2-left-layout" ng-controller="mainCategoryProduct">
                        ...
                        <li class="item col-lg-4 col-md-3 col-sm-4 col-xs-6" ng-repeat="product in products">
                            <div class="col-item">
                                ...
                                <div class="info">
                                    ...
                                    <!--info-inner-->
                                    <div class="actions">
                                        <form method="post" action="<?php echo base_url() . 'onlineshop/go_for_cart_from_main_category/'.$main_category_id; ?>">
                    ...
                    <div class="block-content">
                        ...
                        <dl id="narrow-by-list">
                            ...
                            <dd class="even" ng-repeat="manufacturer in pmanufacturer">
                                <ol>
                                    <li> <a href="" ng-click="fpbymnmc(manufacturer.manufacturer_id)">{{manufacturer.manufacturer_name}}</a> ({{manufacturer.have_product}}) </li>
                            ...
                            <dd class="last even" ng-repeat="size in psize">
                                <ol>
                                    <li> <a href="" ng-click="fpbysnmid(size.size_name)">{{size.size_name}}</a> ({{size.have_product}}) </li>
...
<script>
    client.controller('mainCategoryProduct', function($scope, $http) {
        $scope.products = <?php echo $product; ?>;
        $scope.psize = <?php echo $size; ?>;
        $scope.pmanufacturer = <?php echo $manufacturer; ?>;
        var main_category_id =<?php echo $main_category_id; ?>;
        $scope.method = 'GET';
        $scope.getPrice1 = function() {
            $scope.loading = true;
            $scope.code = null;
            $scope.response = null;
            $scope.url = '<?php echo base_url() ?>onlineshop/m_price_l500/';
        ...
        $scope.getPrice2 = function() {
            ...
            $scope.code = null;
            $scope.response = null;
            $scope.url = '<?php echo base_url() ?>onlineshop/m_price_g500_to1000/';
            $http({method: $scope.method, url: $scope.url + main_category_id}).
                    then(function(response) {
                        $scope.status = response.status;
                        $scope.products = response.data;
        ...
        $scope.getPrice3 = function() {
            ...
            $scope.code = null;
            $scope.response = null;
            $scope.url = '<?php echo base_url() ?>onlineshop/m_price_g1000_to2000/';
            $http({method: $scope.method, url: $scope.url + main_category_id}).
                    then(function(response) {
                        $scope.status = response.status;
                        $scope.products = response.data;
        ...
        $scope.getPrice4 = function() {
            ...
            $scope.code = null;
            $scope.response = null;
            $scope.url = '<?php echo base_url() ?>onlineshop/m_price_g2000_to5000/';
            $http({method: $scope.method, url: $scope.url + main_category_id}).
                    then(function(response) {
                        $scope.status = response.status;
                        $scope.products = response.data;
        ...
        $scope.getPrice5 = function() {
            ...
            $scope.code = null;
            $scope.response = null;
            $scope.url = '<?php echo base_url() ?>onlineshop/m_price_g5000_to10000/';
            $http({method: $scope.method, url: $scope.url + main_category_id}).
                    then(function(response) {
                        $scope.status = response.status;
                        $scope.products = response.data;
        ...
        $scope.getPrice6 = function() {
            ...
            $scope.code = null;
            $scope.response = null;
            $scope.url = '<?php echo base_url() ?>onlineshop/m_price_above10000/';
            $http({method: $scope.method, url: $scope.url + main_category_id}).
                    then(function(response) {
                        $scope.status = response.status;
                        $scope.products = response.data;
        ...
        $scope.fpbymnmc = function(manufacturer_id) {
