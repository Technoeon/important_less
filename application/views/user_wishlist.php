          ...
          <div class="my-account">
            ...
            <div class="my-wishlist">
              <div class="table-responsive">
                <form action="<?php echo base_url();?>onlineshop/user_wishlist" method="post">
                  <fieldset>
                    ...
                    <table id="wishlist-table" class="clean-table linearize-table data-table">
                      ...
                      <tbody>
                        <tr id="item_31" class="first odd">
                          <td class="wishlist-cell0 customer-wishlist-item-image"><a title="Softwear Women's Designer" href="#/catalog/product/view/id/39/s/softwear-women-s-designer/" class="product-image"> <img width="150" height="150" alt="Softwear Women's Designer" src="<?php echo base_url();?>products-images/p6.jpg"> </a></td>
                          <td class="wishlist-cell1 customer-wishlist-item-info"><h3 class="product-name"><a title="Softwear Women's Designer" href="<?php echo base_url();?>/catalog/product/view/id/39/s/softwear-women-s-designer/">Softwear Women's Designer</a></h3>
                        ...
                        <tr id="item_33" class="odd">
                          <td class="wishlist-cell0 customer-wishlist-item-image"><a title="Softwear Women's Designer" href="#/catalog/product/view/id/39/s/softwear-women-s-designer/" class="product-image"> <img width="150" height="150" alt="Softwear Women's Designer" src="<?php echo base_url();?>products-images/p1.jpg"> </a></td>
                          <td class="wishlist-cell1 customer-wishlist-item-info"><h3 class="product-name"><a title="Softwear Women's Designer" href="#/catalog/product/view/id/39/s/softwear-women-s-designer/">Softwear Women's Designer</a></h3>
                            <div class="description std">
                              <div class="inner">A Black Multi-Coloured Printed Leggings for Women from Softwear.</div>
                            </div>
                            <textarea title="Comment" onblur="focusComment(this)" onfocus="focusComment(this)" cols="5" rows="3" name="description[31]" style="height: 120px; width: 96%;"></textarea></td>
                        ...
                        <tr id="item_32" class="last even">
                          <td class="wishlist-cell0 customer-wishlist-item-image"><a title="Slim Fit Casual Shirt" href="#/catalog/product/view/id/2/s/slim-fit-casual-shirt/" class="product-image"> <img width="150" height="150" alt="Slim Fit Casual Shirt" src="<?php echo base_url();?>products-images/p25.jpg"> </a></td>
                          <td class="wishlist-cell1 customer-wishlist-item-info"><h3 class="product-name"><a title="Slim Fit Casual Shirt" href="#/catalog/product/view/id/2/s/slim-fit-casual-shirt/">Slim Fit Casual Shirt</a></h3>
                            <div class="description std">
