                        ...
                        <form class="form-horizontal" action="<?php echo base_url(); ?>te_admin/update_menu" method="post">
                            <div class="form-group">
                                <div class="col-sm-12">
                                    ...
                                    <input type="text" name="product_sku" class="form-control" value="<?php echo $product_info->product_sku;?>"required="1">
                                    <div class="space-4"></div>
                                    <level>Quantity:</level><br><br>
                                    <input type="text" name="product_quantity" class="form-control" value="<?php echo $product_info->product_quantity;?>"required="1">
                                    <div class="space-4"></div>
                                    <level>Price:</level><br><br>
                                    <input type="text" name="product_price" class="form-control" value="<?php echo $product_info->product_price;?>"required="1">
                                    <div class="space-4"></div>
                                    <level>Discount:</level><br><br>
                                    <input type="text" name="" class="form-control" value=""required="1"><br>
                                    <level>Discount Start Date</level>
                                    <input type="date" name="start_date" class="form-control" value="<?php echo $product_info->start_date;?>"required="1"><br>
                                    <level>Discount Ending Date</level>
                                    <input type="date" name="end_date" class="form-control" value="<?php echo $product_info->end_date;?>"required="1"><br>
